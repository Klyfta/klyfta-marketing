...
function CheckPill() {
  return (
    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-brand-300 text-gray-900">
      <svg
        viewBox="0 0 16 16"
        className="h-3 w-3"
        fill="none"
...
function DashPill() {
  return (
    <span className="flex h-5 w-5 items-center justify-center rounded-full border border-gray-700 text-gray-600">
...
export function Comparison() {
  ...
  return (
    <section id="comparison" className="bg-gray-900 py-20 sm:py-32">
      <Container>
        <div>
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-gray-800">
                  ...
                  <th
                    scope="col"
                    className="pb-4 px-4 text-base font-semibold text-white align-bottom"
                  >
                    {t("columns.verkio")}
                  </th>
                  <th
                    scope="col"
                    className="pb-4 px-4 text-base font-medium text-gray-400 align-bottom"
                  >
                    {t("columns.google")}
                  </th>
                  <th
              ...
              <tbody>
                {comparisonRows.map((key, idx) => {
                  ...
                  return (
                    <Fragment key={key}>
                      <tr className={idx > 0 ? "border-t border-gray-800" : ""}>
                        <th
                          scope="row"
                          className="py-5 pr-6 text-sm font-medium text-white align-top"
                        >
                          {t(`rows.${key}.label`)}
                        </th>
                        ...
                        <td colSpan={5} className="p-0">
                          ...
                          >
                            <div className="overflow-hidden">
                              ...
                              >
                                <div className="rounded-lg bg-gray-800/60 p-5 text-sm text-gray-300 leading-relaxed">
                                  {t(`rows.${key}.info`)}
                                </div>
                              </div>
                            </div>
